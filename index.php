...
require_once __DIR__ . '/funct.php';
...
<div class="container">
    ...
    <form action="index.php" method="post" class="row g-3">
        ...
        <div class="col-md-6 offset-md-3">
            <button type="submit" name="auth" class="btn btn-primary">Sing in</button>
        </div>
    </form>
    <?php else: ?>
    ...
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <p>Welcome , <?= htmlspecialchars($_SESSION['user']['name']) ?>! <a href="?do=exit">Log out</a></p>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6 offset-md-3">
            ...
            <div class="card my-3">
                <div class="card-body">
                    <h5 class="card-title">Autor :<?= htmlspecialchars($message['name'])  ?> </h5>
